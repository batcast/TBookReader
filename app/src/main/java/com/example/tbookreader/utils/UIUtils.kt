...
import com.example.tbookreader.lib.theme.primaryTextColor
...
object UIUtils {
    ...
    fun getMenuColor(context: Context, theme: Theme = Theme.Auto, requireOverflow: Boolean = false): Int {
        val defaultTextColor = context.getCompatColor(R.color.tv_text_default)
        if (requireOverflow) return defaultTextColor
